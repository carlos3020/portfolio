  ...
  return (
    <div className="h-full w-full text-center mx-auto">
      ...
      <div className="mb-8">
        ...
        <Link
          className="px-4 py-4 bg-red-600 mr-8 rounded-xl"
          to={preview}
          target="_blank"
        >
          Preview
        ...
        <Link
          className="px-4 py-4 bg-amber-400 rounded-xl"
          to={github}
          target="_blank"
        >
          Github
...
const projects = [
  {
    content: (
      <Card
        image={slide_image_2 ? slide_image_2 : Spinner}
        preview={"https://talk-time.netlify.app/login"}
        github={"https://github.com/carlos3020/chat-app"}
        name={"Chat App"}
      />
    ),
    label: "Chat App",
  },
  {
    content: (
      <Card
        image={slide_image_1 ? slide_image_1 : Spinner}
        preview={"https://todo-app-b96a5.web.app/register"}
        github={"https://github.com/carlos3020/mern-todo-app"}
        name={"Todo App"}
      />
    ),
    label: "Todo App",
...
const Work = () => {
  ...
  return (
    <div className="px-20  w-screen overflow-hidden p-0 m-0 flex flex-col content-center items-center overflow-y-hidden">
      <h2 className="mb-4 text-4xl font-semibold mt-4 xl:mt-0 xl:mb-8  ">
        Work
      </h2>
      ...
      >
        <SwiperSlide className="rounded-xl bg-[#17C3B2]">
          <Link
            ...
            to="https://talk-time.netlify.app/login"
            target="_blank"
          >
        ...
        <SwiperSlide className="rounded-xl bg-orange-500">
          <Link
            className="h-full w-full flex items-center justify-center flex-col"
            to="https://todo-app-b96a5.web.app/register"
            target="_blank"
          >
...
// list-none  mx-0 font-medium text-sm rounded-md rounded-b-none w-full py-2.5 px-16 realtive flex justify-between items-center flex-1 min-w-0 cursor-pointer text-center
    ...
    <div className="w-full  mx-auto bg-white rounded-xl overflow-hidden flex flex-col shadow-lg mb-20 xl:w-[50%] ">
      ...
      <main>
        <AnimatePresence mode="wait">
          ...
          >
            {selectedTab ? selectedTab.content : "No hay"}
          </motion.div>
        </AnimatePresence>
      </main>
    </div>
